...
export default function Home() {
  return <main>
    <nav className="nav"><Link className="wordmark" href="/"><Image src="/app-icon.png" width={38} height={38} alt="家维录图标"/><span>家维录</span></Link><div><a href="#features">功能</a><Link href="/maintenance-calculator">免费工具</Link><Link href="/home-maintenance">保养指南</Link><Link href="/warranty-checklist">保修清单</Link><Link href="/privacy">隐私</Link><Link href="/support">支持</Link></div></nav>
    <section className="hero">
      <div className="heroCopy"><p className="eyebrow">家庭资产护照 · 默认私密</p><h1>房子的记忆，<br/><em>不该散落在相册里。</em></h1><p className="lead">把资产、保修、票据、维护和每一笔服务支出，整理成一份真正有用的家庭档案。</p><div className="badges"><span>无需账户</span><span>无广告</span><span>本地保存</span></div><a className="storeCta" href={appStoreURL} target="_blank" rel="noreferrer">在 App Store 下载家维录 <span>↗</span></a><p className="availability">免费开始使用；中国区 9 月 1 日至 25 日终身 Pro ¥6，9 月 26 日恢复 ¥198；年度 Pro ¥68/年。实际价格与可用性以 App Store 最终展示为准。安装后在总览右上角打开“家维录 Pro”选择方案。</p></div>
